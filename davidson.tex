...
\begin{enumerate}
    ...
    \item
        ...
        \termsymbol{2{}^1A_g} state of hexatriene and its gap with the
        neighboring \termsymbol{1{}^1B_u} state by close to 1~\eV, LR-ODC-12
...
\begin{equation}
    ...
    \end{pmatrix}
\end{equation}
The dimensions of the diagonal two-body blocks in these matrices scale as
...
The full set of linear transformation formulas for LR-ODC-12 is given in the
