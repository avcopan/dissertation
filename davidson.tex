...
\afterpage{%
    ...
    \captionof{figure}{%
        LR-ODC-12 memory profiles for calculating the lowest 20 states of
        ethylene with the def2-SV(P) basis set on an
        Intel\textsuperscript{\textregistered} Core\texttrademark\ i7-5600U
        processor.
        Computed using the CR equation and the FD preconditioner, with subspace
        collapses every 200 vectors.
    }
}
