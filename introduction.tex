...
mystery until Heisenberg's work on two-electron systems in the following year.
...
antisymmetric ones\footnote{%
    The arguments are short-hand for electron space and spin coordinates, as in
    \((1) \equiv (\mathbf{r}_1, \sigma_1)\).
}
\begin{equation}
...
\begin{enumerate}
    \item
        Heisenberg's project to lay out a framework for many-body electronic
        structure theory basically succeeded, but the asymmetric product
        functions were cumbersome to work with.
    \item
        Nowadays\dots
\end{enumerate}
